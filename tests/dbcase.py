...
class DBCase(unittest.TestCase):
    ...
    def setUp(self):
        self.conn.execute("TRUNCATE event, fetch_log, attention_hourly, attention_daily, attention_anomaly, alert, mention, mention_hourly, gkg_article, gkg_location, theme_daily, theme_hourly, firms_detection, fire, wiki_edit, wiki_activity, wiki_page, stream_cursor, chatter_5min, chatter_hourly, bsky_uri, gazetteer_stop")
        self.conn.commit()
