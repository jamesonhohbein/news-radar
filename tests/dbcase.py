...
class DBCase(unittest.TestCase):
    ...
    def setUp(self):
        self.conn.execute("TRUNCATE event, fetch_log, attention_hourly, attention_daily, attention_anomaly, alert, mention, mention_hourly, gkg_article, gkg_location, theme_daily, theme_hourly")
        self.conn.commit()
